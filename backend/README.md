...
## Project Structure
    ...
    ├── testapiautoteammem_108358  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_108358`
...
2. Clone this repo and `cd testapiautoteammem_108358`
